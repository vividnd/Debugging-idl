...
// Helper function to get computation definition PDA for no suffix names
...
// Test initializing with no suffix names
async function testNoSuffixInitialization() {
  try {
    console.log("🧪 Testing no suffix initialization...");
    ...
    // Test survey_analytics (no suffix)
    const compDefName = "survey_analytics" as CompDefName;
    console.log(`\nTesting ${compDefName}...`);
