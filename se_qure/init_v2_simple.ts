/**
 * Simple V2 Computation Definitions Initialization
 * 
 * This script initializes the v2 computation definitions using the same approach
 * as the working v1 script, but with v2 names.
 */
...
async function initializeAllV2CompDefs(): Promise<void> {
  console.log("🚀 SeQure V2 Computation Definitions Initialization (Simple)");
