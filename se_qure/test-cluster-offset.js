...
async function testWithClusterOffset() {
  try {
    console.log('🧪 Testing with Cluster Offset...');
    ...
    console.log('Cluster Offset: 3726127828');
    
    // Create accounts object with cluster offset
    const accounts = {
    ...
    console.log('📋 Attempting to initialize survey_analytics with cluster offset...');
    
    // Try to call the method with cluster offset as argument
...
testWithClusterOffset().catch(console.error);
